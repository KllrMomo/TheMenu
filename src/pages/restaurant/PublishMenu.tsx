...
import { useCurrentUser, useFoodItems, useRestaurants } from "../../services/query-hooks/queries";
import { createImagePreviewUrl, findRestaurantByOwner, formatPrice } from "../../services/utils";
  ...
  return (
    <div className="px-4 py-6 ">
      ...
      {isLoadingFoodItems ? (
        ...
        <div className="flex flex-wrap justify-center gap-10 mb-6">
          {foodItems.slice(0, 3).map((item) => (
            <div
              key={item.foodId}
              className="w-60 h-80 bg-white border border-gray-300 rounded p-4 shadow">
      ...
      <div className="text-center mb-16">
        <Link
          to="/create-menu"
          className="text-[#920728] underline font-semibold hover:text-[#6e0520]">
          Create New Menu
        </Link>
      </div>
