...
import { useRestaurant, useFoodItems } from "../services/query-hooks/queries";
import { formatPrice, isLoading as checkLoading } from "../services/utils";
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="col-span-1 flex justify-center">
                <img src={MenuImage} alt="" onClick={() => setOpen(true)} className="w-full h-full object-cover rounded-lg cursor-pointer" />
                {/* FULLSCREEN MODAL */}
                {open && (
                    <div
